...
[V1.0.0 一期需求总览](requirements/V1.0.0-一期需求总览.md) 已形成专业建议稿，包含8项独立1.0.0需求、64条业务规则及验收场景；需求待确认，同版本详设均为骨架。V1.0.0 是交付批次，不代替单项需求版本；其余历史候选见 [建设顺序](architecture/建设顺序.md)。
